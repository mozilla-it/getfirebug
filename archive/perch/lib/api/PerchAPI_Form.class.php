...
class PerchAPI_Form extends PerchForm
{
    ...
    public function textarea_field($id, $label, $value='', $class='', $use_editor=true)
    {
        if ($use_editor) {
        ...
        $out = $this->field_start($id); 
        $out .= $this->label($id, $this->Lang->get($label), '', $colon=false, $translate=false);
        $out .= $this->textarea($id, $this->get_value($id, $value), $class);
        $out .= $this->field_end($id);
                    ...
                    $Form->enable_html_encoding();
                        ...
                        switch ($tag->type()) {
                            ...
                            case 'textarea':
                                ...
                                $out .= $Form->textarea($item_id, $Form->get($details, $raw_id, $tag->default()), $classname);
