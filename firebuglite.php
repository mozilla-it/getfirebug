<?php
$firebugLiteData = array();
$jsonString = file_get_contents("includes/firebug-lite-data.json");
if ($jsonString)
{
    $firebugLiteData = json_decode($jsonString, true);
}
?>
<!DOCTYPE html>
<html>
...
<script type="text/javascript" src="/releases/lite/latest/firebug-lite.js">
{
    //startOpened: true,
...
.intro {
    ...
    background: LightYellow url(/releases/lite/latest/skin/xp/warningIcon.png) no-repeat 6px 6px;
}
...
<h2 class="heading">Firebug Lite 1.4 release notes</h2>
<div id="blog">

<div class="intro">
    <p>
        Firebug Lite 1.4 is out! Check our
        <a href="http://blog.getfirebug.com/">blog post</a>.
    </p>
</div>
...
<div class="post">
    ...
    <div class="entry">
        <p>
            Since Firebug Lite 1.3.0, there are four distributions channels.
        </p>
        <ul>
            <li>
                <a href="#Stable">Stable channel</a> - this is the main distribution channel.
                The Stable Channel is updated with features and bug fixes
                once they have been properly tested in the Beta channel.
            </li>
            <li>
                <a href="#Debug">Debug channel</a> - the Debug channel uses the same version
                as the Stable channel but with different pre-configurations to
                make it easier to debug Firebug Lite itself.
            </li>
            <li>
                <a href="#Beta">Beta channel</a> - the Beta channel is where the new features
                and fixes are polished. It should be considerably stable (no
                known regression), but it may contain some bugs and some
                features may be incomplete.
            </li>
            <li>
                <a href="#Developer">Developer channel</a> - the Developer channel is where the
                ideas get created and tested. Once it is tied directly to our
                code repository you'll get the most recent code possible and
                will receive updates much more frequently than other channels.
                At the other hand, the Developer channel can be very unstable
                at times and the initial load can be slower.
            </li>
        </ul>
        <p>
            For each distribution channel you can install Firebug Lite using
            three different ways:
        </p>
        <ul>
            <li>
                <b>Bookmarklet</b> - a small bookmarklet to easily install
                Firebug Lite on any web page.
            </li>
            <li>
                <b>Live Link</b> - a link to a copy of the application hosted
                in our servers.
            </li>
            <li>
                <b>Local Link</b> - a link to a local copy of the application
        ...
        <h3><a name="Stable" rel="bookmark"></a>Stable channel</h3>
        <hr />

        <h4>Stable bookmarklet</h4>
        <p class="install-note">
            Add the following link to your bookmarks:
        </p>
        <ul>
            <li><a href="<?php echo $firebugLiteData['stable']['bookmarklet'];?>">Firebug Lite</a></li>
        </ul>

        <h4>Stable live link</h4>
        <p>
            Include the following code at the top of the <code>&lt;head&gt;</code>
            of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['stable']['live'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>

        <h4>Stable local link</h4>
        <p>
            Download <a href="<?php echo $firebugLiteData['stable']['download'];?>">Firebug Lite</a>
            and include the following code at the top of the <code>&lt;head&gt;</code> of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['stable']['local'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>


        <h3><a name="Debug" rel="bookmark"></a>Debug channel</h3>
        <hr />

        <h4>Debug bookmarklet</h4>
        <p class="install-note">
            Add the following link to your bookmarks:
        </p>
        <ul>
            <li><a href="<?php echo $firebugLiteData['debug']['bookmarklet'];?>">Firebug Lite debug</a></li>
        </ul>

        <h4>Debug live link</h4>
        <p>
            Include the following code at the top of the <code>&lt;head&gt;</code>
            of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['debug']['live'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>

        <h4>Debug local link</h4>
        <p>
            Download <a href="<?php echo $firebugLiteData['debug']['download'];?>">Firebug Lite</a>
            and include the following code at the top of the <code>&lt;head&gt;</code> of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['debug']['local'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>



        <h3><a name="Beta" rel="bookmark"></a>Beta channel</h3>
        <hr />

        <h4>Beta bookmarklet</h4>
        <p class="install-note">
            Add the following link to your bookmarks:
        </p>
        <ul>
            <li><a href="<?php echo $firebugLiteData['beta']['bookmarklet'];?>">Firebug Lite beta</a></li>
        </ul>

        <h4>Beta live link</h4>
        <p>
            Include the following code at the top of the <code>&lt;head&gt;</code>
            of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['beta']['live'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>

        <h4>Beta local link</h4>
        <p>
            If you are going to use the Beta channel we recommend using the
            bookmarklet or the live link so you can take advantage of
            automatic updates. But if you want to use it locally anyway,
            download <a href="<?php echo $firebugLiteData['beta']['download'];?>">Firebug Lite</a>
            and include the following code at the top of the <code>&lt;head&gt;</code> of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['beta']['local'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>


        <h3><a name="Developer" rel="bookmark"></a>Developer channel</h3>
        <hr />

        <h4>Developer bookmarklet</h4>
        <p class="install-note">
            Add the link of the desired version to your bookmarks:
        </p>
        <ul>
            <li><a href="<?php echo $firebugLiteData['developer1.4']['bookmarklet'];?>">Firebug Lite 1.4 dev</a></li>
            <li><a href="<?php echo $firebugLiteData['developerFlexBox']['bookmarklet'];?>">Firebug Lite FlexBox dev (the next-generation of Firebug Lite)</a></li>
        </ul>

        <h4>Developer live link</h4>
        <p>
            Include the following code at the top of the <code>&lt;head&gt;</code>
            of your page:
        </p>
...
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['developer1.4']['live'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>
        <p>
            Firebug Lite FlexBox dev (the next-generation of Firebug Lite):
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['developerFlexBox']['live'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>

        <h4>Developer local link</h4>
        <p>
            Checkout <a href="<?php echo $firebugLiteData['developer1.4']['svn'];?>">Firebug Lite code</a>
            and include the following code at the top of the <code>&lt;head&gt;</code> of your page:
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['developer1.4']['local'];?>"&gt;&lt;/script&gt;
</textarea>
        </p>
...
<div class="post">
    ...
    <div class="entry">
        ...
        <ul>
            ...
            <li><code>disableXHRListener</code> - false</li>
...
<textarea rows="2">
&lt;script type="text/javascript" src="<?php echo $firebugLiteData['developer1.3']['local'];?>"&gt;&lt;/script&gt;
</textarea>
        <p>
...
<div class="post">
    ...
    <div class="entry">
        <p>
            ...
            <a href="https://github.com/firebug/firebug-lite/issues/">report us</a>.
        </p>
        <p>
            Found a fix for a particular issue?
            <a href="https://github.com/firebug/firebug-lite/issues/">Patches are welcome</a>.
...
<ul class="navlist">
    ...
    <ul class="navlistsub">
        <li><a href="#Stable">Stable channel</a></li>
        <li><a href="#Debug">Debug channel</a></li>
        <li><a href="#Beta">Beta channel</a></li>
        <li><a href="#Developer">Developer channel</a></li>
    </ul>
